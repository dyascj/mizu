...
<article class="max-w-2xl">
	...
	<p class="text-muted-foreground mb-3 leading-relaxed">
		<a
			...
			target="_blank"
			rel="noreferrer"
			class="text-primary font-medium hover:underline">AGENTS.md</a
		>
		is a README for agents: most coding agents read it from your project root automatically. Mizu maintains
		a canonical one at
		<a
			href="{base}/AGENTS.md"
			class="text-primary font-mono text-[0.9em] font-medium hover:underline">{base}/AGENTS.md</a
		>
	...
	<p class="text-muted-foreground mb-3 leading-relaxed">
		Claude Code reads <code class="bg-muted rounded px-1.5 py-0.5 font-mono text-[0.85em]"
			>CLAUDE.md</code
		>
		first, and Cursor reads
		<code class="bg-muted rounded px-1.5 py-0.5 font-mono text-[0.85em]">.cursor/rules</code>. A
	...
	<p class="text-muted-foreground mb-3 leading-relaxed">
		<a
			href="{base}/llms.txt"
			class="text-primary font-mono text-[0.9em] font-medium hover:underline">{base}/llms.txt</a
		>
	...
	<ul class="text-muted-foreground mb-4 ml-5 list-disc space-y-2">
		...
		<li>
			...
			<a href="/docs/build-a-chat" class="text-primary font-medium hover:underline">Build a chat</a> anatomy,
