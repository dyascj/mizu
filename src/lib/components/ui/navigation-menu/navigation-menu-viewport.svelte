...
<div class="absolute left-0 top-full isolate z-50 flex justify-center">
	<NavigationMenuPrimitive.Viewport
		bind:ref
		class={cn(
			'bg-popover relative mt-2 h-[var(--bits-navigation-menu-viewport-height)] w-full origin-top overflow-hidden rounded-xl dark:border dark:border-border text-popover-foreground shadow-lg transition-[width,height] duration-200 ease-out md:w-[var(--bits-navigation-menu-viewport-width)]',
