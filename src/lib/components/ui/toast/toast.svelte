<script lang="ts" module>
	...
	export const toastVariants = tv({
		base: 'group bg-popover pointer-events-auto relative flex w-full items-start gap-3 overflow-hidden rounded-2xl border border-border py-3.5 pl-4 pr-10 shadow-xl',
		variants: {
			variant: {
				info: '[--toast:var(--info)]',
